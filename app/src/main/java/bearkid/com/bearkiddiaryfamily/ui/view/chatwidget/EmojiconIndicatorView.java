...
public class EmojiconIndicatorView extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        selectedBitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.chat_emoji_dot_selected);
        unselectedBitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.chat_emoji_dot_unselected);
