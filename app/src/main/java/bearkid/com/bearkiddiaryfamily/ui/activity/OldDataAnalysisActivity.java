...
/**
 * 7.13号前数据分析版本，使用ViewPager切换时间轴和图表分析
 * 包括的文件：
 * old_activity_data_analysisysis.xml
 * DataChartFragemnt.java
...
public class OldDataAnalysisActivity extends BaseActivity implements ViewPager.OnPageChangeListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.old_activity_data_analysis);
    ...
    public static void startActivity(Context context){
        context.startActivity(new Intent(context,OldDataAnalysisActivity.class));
    }
