...
import bearkid.com.bearkiddiaryfamily.ui.view.chatwidget.Emojicon.EmojiconInfoProvider;
...
public class EmojiconUtils {
	...
	static {
	    Emojicon[] emojicons = EmojiconDefaultDatas.getData();
	    for(int i = 0; i < emojicons.length; i++){
	        addPattern(emojicons[i].getEmojiText(), emojicons[i].getIcon());
	    }
	    EmojiconInfoProvider emojiconInfoProvider = Emojicon.getEmojiconInfoProvider();
