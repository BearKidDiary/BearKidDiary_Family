...
import bearkid.com.bearkiddiaryfamily.ui.activity.ShowBigImageActivity;
...
public class GalleryFragment extends BaseFragment implements OnScrollListener {
    ...
    protected BaseAdapter mImageAdapter;
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        mImageGridView = (GridView) view.findViewById(R.id.fragment_gallery_gridView);
        initData();
        initView();
...
//        }
    ...
    private class ImageAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ViewHolder holder;
            if (convertView == null) {
                convertView = mInflater.inflate(R.layout.item_gallery_image, parent, false);
                holder = new ViewHolder();
                holder.imageView = (ImageView) convertView.findViewById(R.id.fragment_gallery_image);
