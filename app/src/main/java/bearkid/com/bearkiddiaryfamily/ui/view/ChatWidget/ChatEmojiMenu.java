...
public class ChatEmojiMenu extends LinearLayout{
    protected EaseEmojiMenuListener listener;

    public ChatEmojiMenu(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    public ChatEmojiMenu(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
     ...
     * @param listener:表情监听
     */
    public void setEmojiMenuListener(EaseEmojiMenuListener listener){
        this.listener = listener;
    }

    public interface EaseEmojiMenuListener{
        /**
         * 表情被点击
         * @param chatEmoji:表情类
         */
        void onExpressionClicked(ChatEmoji chatEmoji);
        /**
         * 删除按钮被点击
         */
